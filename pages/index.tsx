...
import { Title, Group, Button, Container, SimpleGrid } from "@mantine/core";
...
const Home: NextPage = () => {
  ...
  return (
    <Layout title="Chip Cart - Home">
      <ImageBG
        imgsource="https://images.unsplash.com/photo-1593640495253-23196b27a87f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80"
        space={300}
      >
      ...
      <ImageBG
        mt={100}
        imgsource="https://images.unsplash.com/photo-1621364525332-f9c381f3bfe8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80"
        space={150}
      >
        <Title ta="center" color="white">
